    ...
    for config in analysis_configs:
        ...
        for discharge in discharges:
            ...
            for scenario_template in scenario_templates:
                ...
                # File paths
                trih_file = os.path.join(model_location, runname, scenario_name, 'test_positivedischarge', 'trih-varriver_tidewest.nc')
...
run_hypsometric_analysis = True         # Set to True to run, set to False to skip this section
...
if run_hypsometric_analysis:
    ...
    # Define timesteps to analyze (you can easily modify these)
    reference_t = 0  # Grey reference line
    analysis_timesteps = np.arange(1, 10, 2)  # [1, 3, 5, 7, 9] - modify as needed
    
    # Alternative timestep options (uncomment to use):
    # analysis_timesteps = np.arange(1, 10, 5)  # [1, 6] 
    # analysis_timesteps = np.arange(5, 20, 3)  # [5, 8, 11, 14, 17]
    # analysis_timesteps = [10, 20, 30, 50, 100]  # Custom selection
