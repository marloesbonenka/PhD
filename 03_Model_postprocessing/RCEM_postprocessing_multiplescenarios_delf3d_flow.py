...
defaultcolour = 'white'
defaultfont = 20
defaultfigsize = (10,8) #(10, 5) for cumulative width-averaged
    ...
    def _plot_combined_width_averaged_profiles_final_timesteps(self, results_per_scenario, save_dir):
        ...
        for scenario, data in results_per_scenario.items():
            ...
            if len(width_averaged_profiles) > 1:
                ...
                label_name = scenario  # Optionally prettify this label
...
if __name__ == "__main__":
    ...
    config.run_cumulative_width_averaged_bedlevel = False

    config.run_multi_scenario_hypsometric = True
    
    config.run_width_averaged_bedlevel = True
    config.run_combined_width_averaged_bedlevel = True     #if True, requirement: run_width_averaged_bedlevel = True
    ...
    # runner.run_specific_scenarios([0, 1], verbose=True)  # Run first two scenario templates
